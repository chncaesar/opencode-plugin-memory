 ...
 */
export const MEMORY_POLICY_EXAMPLES = [
    {
        signal: "correction",
...
const EXAMPLE_LINES = MEMORY_POLICY_EXAMPLES.map((example) => `- User: "${example.user}" -> ${example.decision === "save" ? "SAVE" : "DO NOT SAVE"}: ${example.guidance}.`);
/**
